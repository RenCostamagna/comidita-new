...
export function CategoryPlacesPage({ selectedCategory, onPlaceSelect, onAddReview }: CategoryPlacesPageProps) {
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="rounded-[var(--radius-dropdown)]">
                  <SelectItem value="rating" className="rounded-[var(--radius-dropdown)]">
                    Mejor puntuación
                  </SelectItem>
                  <SelectItem value="reviews" className="rounded-[var(--radius-dropdown)]">
                    Más reseñas
                  </SelectItem>
                  <SelectItem value="name" className="rounded-[var(--radius-dropdown)]">
                    Nombre A-Z
                  </SelectItem>
                </SelectContent>
              </Select>
